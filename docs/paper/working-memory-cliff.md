...
**Tech report draft — v0.2 — 2026-04-11**
**Author**: quant.cpp maintainers
**Status**: Phase 1 Karpathy loop complete — 198 trials measured, results sections filled, related-work section still TODO
...
*To be expanded.* Brief summary of KIVI (channel/token-wise 2-bit), H2O (heavy-hitter eviction), SnapKV (attention-window-based selection), PyramidKV (per-layer budget), and quant.cpp's turbo_kv family (Polar + QJL 3-bit/4-bit).

### 2.2 Long-context retrieval

*To be expanded.* "Lost in the Middle" (Liu et al. 2023), Needle in a Haystack (Kamradt 2023), RULER (Hsieh et al. 2024), LongBench (Bai et al. 2023).

### 2.3 Edge-device LLM inference

*To be expanded.* llama.cpp, MLC, quant.cpp. Emphasis on the Q4/Q8 weight regime for 16 GB consumer hardware.
...
198 NIAH trials in total: R1 = 36 (3B Q4 baseline at 512/1024), R2 = 90 (1B Q8 ceiling sweep), R3 = 72 (3B Q4 ceiling probe at 1280–2048).
...
*Draft generated by the Phase 1 Karpathy loop. Results sections 4.2, 4.3, 4.4 populated when grids complete.*
